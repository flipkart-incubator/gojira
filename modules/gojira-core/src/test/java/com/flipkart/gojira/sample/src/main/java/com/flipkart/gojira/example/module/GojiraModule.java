...
public class GojiraModule extends AbstractModule {
    ...
    private static final String JSON_DIFF_IGNORES_PATH = "com/flipkart/gojira/sample/config/dev/gojiraConfig.json";
    private static final String GOJIRA_CONFIG_PATH = "com/flipkart/gojira/sample/config/dev/jsonDiffIgnorePatterns.json";
    private static final String BIQ_QUEUE_PATH = "com/flipkart/gojira/sample/config/dev/queue-messages";
    ...
    protected void configure() {
        ...
        DataStoreConfig dataStoreConfig = DataStoreConfig.builder()
                .setDataStoreHandler(new FileBasedDataStoreHandler("/Users/narendra.vardi/workspaces/gojira-sample/gojira-sample/datastore"))
                .build();
        ...
        externalConfigMap.put("DEFAULT", Lists.newArrayList((ExternalConfig) externalConfigMap));
