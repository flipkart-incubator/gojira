...
/**
 * Guice module which takes {@link DataStoreConfig} and binds {@link SinkHandler} to provided
...
public class DataStoreModule extends AbstractModule {
  ...
  protected void configure() {
    bind(SinkHandler.class).toInstance(dataStoreConfig.getDataStoreHandler());
  }
}
