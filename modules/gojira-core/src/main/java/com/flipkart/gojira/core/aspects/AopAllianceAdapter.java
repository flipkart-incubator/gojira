...
public abstract class AopAllianceAdapter {
  ...
  /**
   * Return the interceptor to use at method execution join points. Must be overridden by
   * subclasses.
   *
  ...
  /**
   * This advice will be called before and after {@link #targetJoinPoint()} and {@link
   * #methodExecution()} methods.
   */
  ...
  public Object around(ProceedingJoinPoint thisJoinPoint) throws Throwable {
    MethodInvocationClosure mic =
        new MethodInvocationClosure(thisJoinPoint) {
