...
public class TestData<InputData extends TestRequestData<T>, OutputData extends TestResponseData<T>, T extends TestDataType> {
  ...
  private ConcurrentHashMap<String,
      ConcurrentSkipListMap<Long, ConcurrentHashMap<MethodDataType, List<MethodData>>>> methodDataMap =
  ...
  public void setMethodDataMap(
      ConcurrentHashMap<String, ConcurrentSkipListMap<Long, ConcurrentHashMap<MethodDataType, List<MethodData>>>> methodDataMap) {
  ...
  public void setRequestData(InputData requestData) {
  ...
  public void setResponseData(OutputData responseData) {
