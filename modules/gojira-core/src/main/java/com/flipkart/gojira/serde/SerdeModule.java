...
public class SerdeModule extends AbstractModule {
  ...
  protected void configure() {
    SerdeHandlerRepository serdeHandlerRepository = new SerdeHandlerRepositoryImpl();
    serdeHandlerRepository.setDefaultSerdeHandler(serdeConfig.getDefaultSerdeHandler());
